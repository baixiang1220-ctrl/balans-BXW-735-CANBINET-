...
function buildCabinet() {
  ...
  for (const x of [-0.024, 0.024]) {
    cylinder("paired_brushed_gold_vertical_handle", 0.012, 0.57, { x, y: frontY - 0.068, z: 0.97 }, goldWood, { x: 0, y: 0, z: 0 }, cabinet, 36);
    box("handle_flat_front_highlight", { x: 0.009, y: 0.006, z: 0.5 }, { x, y: frontY - 0.081, z: 0.97 }, new THREE.MeshStandardMaterial({ color: 0xf3ce84, roughness: 0.28, metalness: 0.34 }), cabinet, 0.004);
    box("side_visible_handle_depth_spine", { x: 0.018, y: 0.026, z: 0.5 }, { x, y: frontY - 0.054, z: 0.97 }, goldWood, cabinet, 0.006);
    cylinder("handle_top_mount", 0.015, 0.025, { x, y: frontY - 0.054, z: 1.25 }, goldWood, { x: Math.PI / 2, y: 0, z: 0 }, cabinet, 32);
    cylinder("handle_bottom_mount", 0.015, 0.025, { x, y: frontY - 0.054, z: 0.69 }, goldWood, { x: Math.PI / 2, y: 0, z: 0 }, cabinet, 32);
  }
